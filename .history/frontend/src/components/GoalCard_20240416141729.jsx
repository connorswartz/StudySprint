      ...
      <CardBody>
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <Button
            ...
            size="sm"
            light
            style={{ backgroundColor: red, borderRadius: "50%", height: "60px", display: "flex", justifyContent: "center", alignItems: "center" }}
          >
            -
          </Button>
          ...
          <Button
            ...
            size="sm"
            light
            style={{ borderRadius: "50%", height: "60px", display: "flex", justifyContent: "center", alignItems: "center" }}
          >
            +
          </Button>
        </div>
