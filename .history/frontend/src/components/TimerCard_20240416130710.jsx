...
const TimerCard = ({ selectedTask, onTaskUpdate }) => {
  ...
  const [duration, setDuration] = useState(560); // Duration in seconds
  ...
  }, [selectedTask, onTaskUpdate, duration, remainingTime, startTime]);
        ...
        {showModal ? (
          ...
          <>
            ...
            <div className="flex justify-center gap-4 mt-4">
              <Button onClick={handleStartStop} color="primary">
