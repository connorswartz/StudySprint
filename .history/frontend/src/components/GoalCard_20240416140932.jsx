...
import { Card, CardBody, CardFooter, Input, Button, Text } from "@nextui-org/react";
    ...
    <Card>
      ...
      <CardBody>
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
          <Button onClick={handleDecrement} size="sm" light>
            -
          </Button>
          <Text h2 style={{ margin: "0 16px" }}>
            {goal}
          </Text>
          <Button onClick={handleIncrement} size="sm" light>
            +
          </Button>
        </div>
